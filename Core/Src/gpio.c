...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, SERVO3_Pin|SERVO4_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, SERVO1_Pin|SERVO2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SERVO3_Pin SERVO4_Pin */
